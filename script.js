...
/* =========================================================
   NOVARQ — FINAL TEAM CINEMATIC
   CORRECT TEAM NAMES + DUST EXIT
========================================================= */
...
(function () {
    ...
    function startCinematic() {
        ...
        const scene = createCinematic();

        const overlay = scene.overlay;
        const black = scene.black;
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                requestAnimationFrame(function () {
                    ...
                    /* Hide black base only after dust exists */
                    setTimeout(function () {
    ...
    /* Replace logo so OLD RO LI listener cannot interfere */
